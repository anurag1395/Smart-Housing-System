...
$(document).ready(function(){
    ...
    if(localStorage.getItem("name") !=""){
        $("#posted-events").append("<div id ='" + counter + "' class = 'event-row'>Hello I am " + localStorage.getItem("name") + ". I need someone to babysit my" + localStorage.getItem("age1") + " year old child on " + localStorage.getItem("date") +
...
function myFunction() {
    ...
    if($("#myPopup").is(":visible")){
        ...
        // if(localStorage.getItem("name2")!=""){
            ...
            $("#myPopup").append("Hey! "+ localStorage.getItem("name") + " has confirmed you as the babysitter <br>Contact : " +  localStorage.getItem("contact") +" for further communication</span>")
        // }else{

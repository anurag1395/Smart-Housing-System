$(document).ready(function(){
    ...
    function getHeading(){
        if(section==1){
            heading = "Find Homeowner's communities near you :";
        }else if(section==2){
            heading = "Find Homeowner's communities near you :";
        }
        else if(section==3){
            heading = "Please enter your personal and residentialdetails :";
        }
        else if(section==0){
            heading = "Please enter your preferred Username and Password :";
        }else if(section==4){
            heading = "Registeration Complete!!";
        }
    ...
    $(".form-section-"+ section).hide();--section;$(".form-section-"+ section).show();
    getHeading();}, 2000);
    });
...
function populateCity(){
    ...
    for(i=0;i<returnedArray.length;i++){
        ...
        opt.value = returnedArray[i];
        console.log(opt.value);
        opt.innerHTML = returnedArray[i];
...
function Checknull(){
    ...
    if(Nameempty==true || Passwordempty==true){
            $("#Next-btn1").attr("disabled",true);
        }
        else{
            $("#Next-btn1").attr("disabled",false);
        }
}
function Checknull2(){
    ...
    if(Nameempty==true || Passwordempty==true){
            $("#Next-btn4").attr("disabled",true);
        }
        else{
            $("#Next-btn4").attr("disabled",false);
        }
}